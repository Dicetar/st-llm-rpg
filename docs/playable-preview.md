...
- deterministic Session Home recap and illustrated in-app Player Guide, with no extra model call or persistence path;
...
- Live Tracker create/edit/adjust/remove, Relationship Map navigation, 44px controls, and no-overflow checks pass against a production build at 1440px and 360px in `docs/evidence/workspace-live-session-state-browser-2026-08-13.json`. Session Home, record navigation, detailed in-place creation, dirty-draft protection, and Player Guide evidence remains in `docs/evidence/workspace-session-home-browser-2026-08-13.json`. This is desktop browser automation, not physical-phone acceptance.
