...
- Session Home, record navigation, detailed in-place creation, dirty-draft protection, Player Guide, and no-overflow checks pass against a production build at 1280px and 360px in `docs/evidence/workspace-session-home-browser-2026-08-13.json`. This is desktop browser automation, not physical-phone acceptance.
