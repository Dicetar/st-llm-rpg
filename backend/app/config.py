...
LM_STUDIO_NARRATION_MAX_TOKENS = int(os.getenv("LM_STUDIO_NARRATION_MAX_TOKENS", "220"))
LM_STUDIO_EXTRACTOR_MAX_TOKENS = int(os.getenv("LM_STUDIO_EXTRACTOR_MAX_TOKENS", "220"))
LM_STUDIO_SUMMARY_MAX_TOKENS = int(os.getenv("LM_STUDIO_SUMMARY_MAX_TOKENS", "420"))
