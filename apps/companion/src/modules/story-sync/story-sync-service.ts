  ...
  return [
    {
      ...
      content: [
        ...
        'Allowed operation kinds are create_actor, update_actor, create_item, update_item, create_quest, update_quest, create_place, update_place, create_ability, update_ability, create_relationship, update_relationship, and set_current_scene.',
