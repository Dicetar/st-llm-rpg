  ...
  return [
    {
      ...
      content: [
        ...
        'Allowed operation kinds are create_actor, update_actor, create_item, update_item, create_quest, update_quest, create_place, update_place, create_fact, update_fact, create_world_object, update_world_object, create_ability, update_ability, create_relationship, update_relationship, and set_current_scene.',
        'Facts are durable propositions. World Objects are persistent non-portable objects or features; use Items for portable possessions.',
        'Relationships are directed. Propose one only when the chat explicitly establishes or changes the source Actor, target Actor, kind, or status; never infer affinity.',
        'Ability category must be spell, skill, feat, or other. Propose a definition only; a person assigns it to an Actor in the Ability editor.',
